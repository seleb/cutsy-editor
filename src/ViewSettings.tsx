	...
	return (
		<Page>
			...
			<dl className={styles.settings}>
				<dt>theme</dt>
				<dd>
					<label><input onChange={onRadio} type="radio" name="theme" value="auto" checked={settings.theme === "auto"} /> auto</label>
					<label><input onChange={onRadio} type="radio" name="theme" value="dark" checked={settings.theme === "dark"} /> dark</label>
					<label><input onChange={onRadio} type="radio" name="theme" value="light" checked={settings.theme === "light"} /> light</label>
				</dd>

				<dt>font</dt>
				<dd>
					<label><input onChange={onRadio} type="radio" name="font" value="Bitch" checked={settings.font === "Bitch"} /> Bitch</label>
				...
				<dt>save audio</dt>
				<dd>
					<label><input onChange={onRadio} type="radio" name="saveAudio" value="always" checked={settings.saveAudio === "always"} /> always export with audio</label>
					<label><input onChange={onRadio} type="radio" name="saveAudio" value="never" checked={settings.saveAudio === "never"} /> never export with audio</label>
					<label><input onChange={onRadio} type="radio" name="saveAudio" value="editor" checked={settings.saveAudio === "editor"} /> respect editor mute button</label>
				</dd>

				<dt>open files after saving</dt>
				<dd>
					<label><input onChange={onRadio} type="radio" name="openAfterSave" value="true" checked={settings.openAfterSave === "true"} /> yes please</label>
					<label><input onChange={onRadio} type="radio" name="openAfterSave" value="false" checked={settings.openAfterSave === "false"} /> no thanks</label>
				</dd>

				<dt>reset to default</dt>
				<dd>
					<Button onClick={reset} title="Reset settings"><Icon icon="danger" /></Button>
				</dd>
			</dl>

			<PageHeader className={styles.abouth}>
				about
			</PageHeader>
			<p>
